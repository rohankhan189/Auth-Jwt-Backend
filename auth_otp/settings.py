"""
Django settings for auth_otp project.
...
SECRET_KEY = 'django-insecure-c3(#n%82gr+n95ccktxp%s4gmhf0pubzd(&@7(h0@npa6^7!d_'
...
WSGI_APPLICATION = 'auth_otp.wsgi.application'
